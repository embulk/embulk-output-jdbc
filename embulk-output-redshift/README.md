...
- **copy_unload_iam_role_name**: IAM Role for COPY and UNLOAD credential(https://docs.aws.amazon.com/redshift/latest/dg/copy-usage_notes-access-permissions.html), if this is set, use this instead of aws access key and aws secret access key(string, default: "")
